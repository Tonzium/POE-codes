...
def setup_for_crafting(counter_craft, max_items, max_loc, template):
    ...
    if counter_craft < max_items:
        ...
        pyautogui.moveTo(max_loc[0] + template.shape[1] // 2 - 110, max_loc[1] + template.shape[0] // 2 + 540)
...
### Craft THE BOW IN POSITION 5
    ...
    ### Always end the loop at the end of code
    #six_bow_run = False
...
############ AT THIS POINT ALL BOWS AT INVENTORY ARE READY #################
    ...
    # Always end the loop at the end
    six_bow_run = False
